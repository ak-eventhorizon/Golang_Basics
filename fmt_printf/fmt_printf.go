...
func main() {
	...
	fmt.Printf("bin: %b", 147) // %b: для вывода целых чисел в двоичной системе
	fmt.Println("")
	...
	fmt.Printf("hex: %x", 506) // %x: для вывода целых чисел в шестнадцатиричной системе, буквенные символы числа имеют нижний регистр a-f
	fmt.Println("")

	fmt.Printf("HEX: %X", 506) // %X: для вывода целых чисел в шестнадцатиричной системе, буквенные символы числа имеют верхний регистр A-F
	fmt.Println("")
